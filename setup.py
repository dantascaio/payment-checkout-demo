...
with io.open("./payment_checkout_api/__init__.py", encoding="utf8") as version_f:
...
setup(
    name="payment_checkout_api",
    version=version,
    author="Caio Dantas",
    author_email="caiodantas@gmail.com",
    packages=find_packages(exclude="tests"),
    include_package_data=True,
    url=("https://github.com/dantascaio/payment-checkout-demo"),
    license="MIT",
    ...
    keywords=[],
    entry_points={
        "console_scripts": ["payment_checkout_api = payment_checkout_api.main:app"],
    },
)
